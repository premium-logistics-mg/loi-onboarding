<#
LOI onboarding harvest script — v0 mechanic-field-app for trucks.conso / mechanics mobile review
Date: 2026-05-24
...
Execution model:
1. The authoritative ZIP source remains harvests\2026-05-24_v0_mechanic_field_app_trucks_conso\raw\mechanic-field-app.zip.
...
4. This script pushes only branch harvest/v0-mechanic-field-app-trucks-conso-20260524.
#>
...
$ZipFileName = "mechanic-field-app.zip"
$HarvestName = "2026-05-24_v0_mechanic_field_app_trucks_conso"
...
$Branch = "harvest/v0-mechanic-field-app-trucks-conso-20260524"
$CommitMessage = "harvest(onboarding): add v0 mechanic field app prototype"
$TempRoot = Join-Path $env:TEMP "loi-onboarding-mechanic-field-app-harvest"
...
@"
# Harvest — v0 mechanic-field-app for trucks.conso / mechanics mobile review

[FAIT] This folder is an onboarding harvest for CC review.

[FAIT] Source v0 link: https://v0.app/chat/mechanic-field-app-o4CKkTDH4i6

[FAIT] Authoritative ZIP source in this harvest: `raw/mechanic-field-app.zip`.

[FAIT] Intended candidate persona approved by Kenny: `trucks-conso-001` / `trucks.conso@premiumlogistics.mg`.

[FAIT] Scope: mechanic field mobile capture flow intended to feed maintenance, truck condition, breakdown, intervention, and service-event workflows.
