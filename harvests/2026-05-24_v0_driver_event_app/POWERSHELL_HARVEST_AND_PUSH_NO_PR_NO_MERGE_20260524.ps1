<#
LOI onboarding harvest script — v0 driver-event-app for driver mobile event capture review
Date: 2026-05-24
...
Execution model:
1. The authoritative ZIP source remains harvests\2026-05-24_v0_driver_event_app\raw\driver-event-app.zip.
...
4. This script pushes only branch harvest/v0-driver-event-app-20260524.
#>
...
$ZipFileName = "driver-event-app.zip"
$HarvestName = "2026-05-24_v0_driver_event_app"
...
$Branch = "harvest/v0-driver-event-app-20260524"
$CommitMessage = "harvest(onboarding): add v0 driver event app prototype"
$TempRoot = Join-Path $env:TEMP "loi-onboarding-driver-event-app-harvest"
...
@"
# Harvest — v0 driver-event-app for driver mobile event capture review

[FAIT] This folder is an onboarding harvest for CC review.

[FAIT] Source v0 link: https://v0.app/chat/driver-event-app-h2BIKmxVz20

[FAIT] Authoritative ZIP source in this harvest: `raw/driver-event-app.zip`.

[FAIT] Scope requested by Kenny: Driver Event App mobile module harvested from v0.

[HYPOTHÈSE] Intended workflow coverage is driver-side event capture for operational checkpoints, incidents/anomalies, proof capture, and exploitation/operations visibility.

[FAIT] Guardrail: this harvest does not merge, deploy, mutate loi-cockpit, or activate runtime RBAC/personas.

[À CONFIRMER] CC must validate final route, component mapping, driver event schema, offline sync assumptions, actor identity, and production integration path before any merge/deploy.

[À CONFIRMER] Kenny must validate whether this Driver Event module is operated only by the driver, or also by dispatch/exploitation agents.
