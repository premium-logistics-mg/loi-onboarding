<#
LOI onboarding harvest script — v0 tire-event-mobile for trucks.conso
Date: 2026-05-24
...
Before running:
1. Authoritative ZIP source is harvest\raw\tire-event-mobile(1).zip.
2. Downloads is fallback only.
3. This script pushes only branch harvest/v0-tire-event-mobile-trucks-conso-20260524.
#>
...
$ZipFileName = "tire-event-mobile(1).zip"
$DownloadsZipPath = Join-Path $env:USERPROFILE "Downloads\$ZipFileName"
$HarvestName = "2026-05-24_v0_tire_event_mobile_trucks_conso"
...
$Branch = "harvest/v0-tire-event-mobile-trucks-conso-20260524"
$CommitMessage = "harvest(onboarding): add v0 tire event mobile prototype"
...
@"
# Harvest — v0 tire-event-mobile for trucks.conso

[FAIT] This folder is an onboarding harvest for CC review.

[FAIT] Source v0 link: https://v0.app/chat/tire-event-mobile-stCHNkPRi0T

[FAIT] Authoritative ZIP source in this harvest: `raw/tire-event-mobile(1).zip`.

[FAIT] Intended candidate persona approved by Kenny: `trucks-conso-001` / `trucks.conso@premiumlogistics.mg`.

[FAIT] Scope: tire event mobile capture flow for pneus/carburant cockpit inspiration.
