...
// ── Variant A — Navy strip, équilibré (flex-wrap responsive)
  ...
  return (
    <div style={{
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 8, minWidth: 220, flex: "1 1 220px" }}>
        ...
        <div style={{ fontSize: 19, fontWeight: 600, color: "var(--pl-cream)", letterSpacing: "-0.015em", lineHeight: 1.25 }}>
          {SO_DATA.title}
        </div>
      </div>
      ...
      {/* Right metrics — will wrap below at narrow widths */}
      <div style={{ display: "flex", gap: 8, flexShrink: 0 }}>
        <div style={{
          padding: "8px 14px", borderRadius: 8, minWidth: 88, textAlign: "center",
...
// ── Variant B — Cream/Light card with bold teal (flex-wrap responsive)
