...
const HERO_KPIS = [
  { id: "h1", label: "DDV ouvertes",   value: 7,  unit: "objets",           tone: "neutral", icon: "clipboard" },
  { id: "h2", label: "En retard",      value: 2,  unit: "délais dépassés",  tone: "danger",  icon: "alert" },
  { id: "h3", label: "Montant cumulé", value: "51.85", unit: "M MGA",       tone: "accent",  icon: "pillar-cash", isMontant: true },
];
...
const COMPLIANCE = [
  { id: "tva",  label: "TVA à temps",   current: 12, total: 12, unit: "mois",     echeance: "15 juin 2026", status: "ok" },
  { id: "irsa", label: "IRSA à temps",  current: 12, total: 12, unit: "mois",     echeance: "15 juil. 2026", status: "ok" },
];
